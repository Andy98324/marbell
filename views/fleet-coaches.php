...
<section class="relative overflow-hidden bg-[#0b1220] text-white">
  ...
  <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
    <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight"><?= t('fleet.coaches.h1') ?></h1>
    <p class="mt-3 text-white/80 text-lg leading-relaxed max-w-3xl"><?= t('fleet.coaches.lead') ?></p>
  </div>
</section>
...
<section class="py-16 bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="row align-items-center g-4">
      <div class="col-md-6">
        <img src="/assets/images/autocar.index.png"
             alt="<?= t('fleet.coaches.alt') ?>"
             class="w-100 object-contain bg-light rounded-2xl border shadow">
      </div>
      <div class="col-md-6">
        <h2 class="h4 text-dark mb-3"><?= t('fleet.coaches.specs.title') ?></h2>
        <ul class="list-unstyled text-muted">
          <li>• <?= t('fleet.coaches.specs.pax') ?></li>
          <li>• <?= t('fleet.coaches.specs.luggage') ?></li>
          <li>• <?= t('fleet.coaches.specs.features') ?></li>
        </ul>
      ...
      <?php foreach (['f1','f2','f3'] as $k): ?>
        <div class="col-md-4">
          <div class="rounded-2xl bg-white border shadow-sm p-4 h-100">
            <h3 class="h6 text-dark mb-1"><?= t("fleet.coaches.features.$k.title") ?></h3>
            <p class="text-muted mb-0"><?= t("fleet.coaches.features.$k.text") ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
    ...
    <div class="mt-5 row g-4">
      <?php
        $gallery = [
          ['/assets/images/fleet/coaches/01.jpg', t('fleet.coaches.gallery.1')],
          ['/assets/images/fleet/coaches/02.jpg', t('fleet.coaches.gallery.2')],
          ['/assets/images/fleet/coaches/03.jpg', t('fleet.coaches.gallery.3')],
        ];
