...
<section class="py-16 bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-6 md:grid-cols-3">
      <?php
        $gallery = [
          ...
          ['/assets/images/guided/sevilla-essential/patios_sevilla.jpg','Patios del Alcázar / Sevilla'],
        ];
            ...
            <table class="w-full text-sm">
              ...
              <tbody class="text-zinc-800">
                ...
                foreach ($rows as $i => [$pax,$price]):
                  $msg = "I want to book a guided tour to the Alcazar & Cathedral for {$pax} people without transfer for {$price}€";
                ?>
                ...
                <!-- 8+ -->
                <?php $msg8 = "I want to consult a reservation for 8 or more people for the Alcazar & Cathedral tour"; ?>
          ...
          <table class="w-full text-sm">
            ...
            <tbody class="text-zinc-800 divide-y divide-zinc-100">
              <?php foreach (['2','3','4','5','6','7','8+'] as $pax):
                $msgT = "I want information for a guided Alcazar & Cathedral tour with transfer for {$pax} passengers";
              ?>
              <tr>
                <td class="py-3 px-3"><?= htmlspecialchars($pax) ?> pax</td>
                <td class="py-3 px-3">
    ...
    <div class="mt-12 text-sm text-zinc-600 text-center space-y-2">
      <p>ℹ️ <?= t('guided.sevilla_ac.notes.tickets') ?></p>
...
<?= json_encode([
  ...
  '@type'=>'TouristTrip',
  'name'=> t('guided.sevilla_ac.title_short'),
  'description'=> strip_tags(t('guided.sevilla_ac.lead')),
  'provider'=>[
    '@type'=>'TravelAgency',
  ...
  'offers'=>[
    ...
    'url'=>'https://www.transfermarbell.com/servicios/visitas-guiadas/sevilla-alcazar-catedral'
  ],
  'image'=>[
    'https://www.transfermarbell.com/assets/images/guided/sevilla-ac/Plaza_espana_sevilla.jpg',
    'https://www.transfermarbell.com/assets/images/guided/sevilla-ac/Puerta_sevilla.jpg',
    'https://www.transfermarbell.com/assets/images/guided/sevilla-ac/patios_sevilla.jpg'
  ]
