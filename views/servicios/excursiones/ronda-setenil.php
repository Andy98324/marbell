...
<section class="relative overflow-hidden bg-[#0b1220] text-white">
  ...
  <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
    <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight"><?= t('excursions.ronda.h1') ?></h1>
    <p class="mt-3 text-white/80 text-lg leading-relaxed max-w-3xl"><?= t('excursions.ronda.lead') ?></p>
  </div>
</section>
  ...
  <div class="mx-auto max-w-3xl px-4 text-center">
    ...
    <div class="mt-10 mx-auto max-w-md text-left">
      <div class="rounded-2xl bg-white ring-1 ring-black/10 shadow-md p-6">
        <h3 class="text-lg font-semibold text-zinc-900 mb-3"><?= t('excursions.includes.title') ?? 'Incluye:' ?></h3>
