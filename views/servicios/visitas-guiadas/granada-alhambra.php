...
<section class="relative overflow-hidden bg-[#0b1220] text-white">
  ...
  <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
    <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight"><?= t('guided.granada.h1') ?></h1>
    <p class="mt-3 text-white/80 text-lg leading-relaxed max-w-3xl"><?= t('guided.granada.lead') ?></p>
  </div>
</section>
...
<section class="py-16 bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-6 md:grid-cols-3">
      <?php
        $gallery = [
          ['/assets/images/guided/alhambra/Alhambra_jardin.jpg','Generalife Gardens / Alhambra'],
          ['/assets/images/guided/alhambra/Alhambra_torre.jpg','Alcazaba Tower / Alhambra'],
          ['/assets/images/guided/alhambra/Alhambra_barrio_castrense.jpg','Palaces & Military Quarter / Alhambra'],
        ];
            ...
            <table class="w-full text-sm">
              ...
              <tbody class="text-zinc-800">
                ...
                foreach ($rows as $i => [$pax,$price]):
                  $msg = "I want to book a guided tour to the Alhambra for {$pax} people for {$price}€";
                ?>
                  ...
                  <td class="py-3 px-3">
                    <div class="flex flex-wrap gap-2">
                      <a class="inline-flex items-center gap-1 rounded-full bg-green-50 text-green-700 ring-1 ring-green-200 px-3 py-1 hover:bg-green-100"
                         ...
                         href="https://wa.me/34692926919?text=<?= rawurlencode($msg) ?>"><?= t('guided.common.whatsapp') ?></a>
                      <a class="inline-flex items-center gap-1 rounded-full bg-sky-50 text-sky-700 ring-1 ring-sky-200 px-3 py-1 hover:bg-sky-100"
                         target="_blank" rel="noopener"
                         href="https://t.me/34692926919?text=<?= rawurlencode($msg) ?>"><?= t('guided.common.telegram') ?></a>
                    </div>
                  </td>
                </tr>
                <?php endforeach; ?>
                ...
                <!-- 8+ -->
                <?php $msg8 = "I want to consult a reservation for 8 or more people for the Alhambra tour"; ?>
                <tr class="bg-white border-t border-zinc-100">
                  ...
                  <td class="py-3 px-3">
                    <div class="flex flex-wrap gap-2">
                      <a class="inline-flex items-center gap-1 rounded-full bg-green-50 text-green-700 ring-1 ring-green-200 px-3 py-1 hover:bg-green-100"
                         target="_blank" rel="noopener"
                         href="https://wa.me/34692926919?text=<?= rawurlencode($msg8) ?>"><?= t('guided.common.whatsapp') ?></a>
                      <a class="inline-flex items-center gap-1 rounded-full bg-sky-50 text-sky-700 ring-1 ring-sky-200 px-3 py-1 hover:bg-sky-100"
                         target="_blank" rel="noopener"
                         href="https://t.me/34692926919?text=<?= rawurlencode($msg8) ?>"><?= t('guided.common.telegram') ?></a>
                    </div>
                  </td>
                </tr>
          ...
          <table class="w-full text-sm">
            ...
            <tbody class="text-zinc-800 divide-y divide-zinc-100">
              <?php foreach (['2','3','4','5','6','7','8+'] as $pax):
                $msgT = "I want information for a guided Alhambra tour with transfer for {$pax} passengers";
              ?>
              <tr>
                <td class="py-3 px-3"><?= htmlspecialchars($pax) ?> pax</td>
                <td class="py-3 px-3">
                  <div class="flex flex-wrap gap-2">
                    <a class="inline-flex items-center gap-1 rounded-full bg-green-50 text-green-700 ring-1 ring-green-200 px-3 py-1 hover:bg-green-100"
                       target="_blank" rel="noopener"
                       href="https://wa.me/34692926919?text=<?= rawurlencode($msgT) ?>"><?= t('guided.common.whatsapp') ?></a>
                    <a class="inline-flex items-center gap-1 rounded-full bg-sky-50 text-sky-700 ring-1 ring-sky-200 px-3 py-1 hover:bg-sky-100"
                       target="_blank" rel="noopener"
                       href="https://t.me/34692926919?text=<?= rawurlencode($msgT) ?>"><?= t('guided.common.telegram') ?></a>
                  </div>
                </td>
              </tr>
              <?php endforeach; ?>
    ...
    <div class="mt-12 text-sm text-zinc-600 text-center space-y-2">
      <p>ℹ️ <?= t('guided.granada.notes.tickets') ?></p>
    ...
    <div class="mt-10 text-center">
      <a href="https://wa.me/34692926919" target="_blank" rel="noopener"
        ...
        <span class="relative z-10"><?= t('guided.granada.cta.info') ?></span>
...
<?= json_encode([
  ...
  '@type'=>'TouristTrip',
  'name'=> t('guided.granada.title_short'),
  'description'=> strip_tags(t('guided.granada.lead')),
  'provider'=>[
    '@type'=>'TravelAgency',
  ...
  'offers'=>[
    ...
    'url'=>'https://www.transfermarbell.com/servicios/visitas-guiadas/granada-alhambra'
  ],
  'image'=>[
    'https://www.transfermarbell.com/assets/images/guided/granada/Alhambra_jardin.jpg',
    'https://www.transfermarbell.com/assets/images/guided/granada/Alhambra_torre.jpg',
    'https://www.transfermarbell.com/assets/images/guided/granada/Alhambra_barrio_castrense.jpg'
  ]
