...
<section class="relative overflow-hidden bg-[#0b1220] text-white">
  ...
  <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
    <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight"><?= t('guided.granada_city.h1') ?></h1>
    <p class="mt-3 text-white/80 text-lg leading-relaxed max-w-3xl"><?= t('guided.granada_city.lead') ?></p>
  </div>
</section>
...
<section class="py-16 bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-6 md:grid-cols-3">
      <?php
        $gallery = [
          ['/assets/images/guided/granada/Alhambra_jardin.jpg','Granada / Generalife gardens'],
          ['/assets/images/guided/granada/Alhambra_torre.jpg','Granada / Alcazaba tower view'],
          ['/assets/images/guided/granada/Alhambra_barrio_castrense.jpg','Granada / Historic quarters'],
        ];
            ...
            <table class="w-full text-sm">
              ...
              <tbody class="text-zinc-800">
                ...
                foreach ($rows as $i => [$pax,$price]):
                  $msg = "I want to book a guided Granada city tour for {$pax} people for {$price}€";
                ?>
                ...
                <!-- 8+ -->
                <?php $msg8 = "I want to consult a reservation for 8 or more people for the Granada city tour"; ?>
          ...
          <table class="w-full text-sm">
            ...
            <tbody class="text-zinc-800 divide-y divide-zinc-100">
              <?php foreach (['2','3','4','5','6','7','8+'] as $pax):
                $msgT = "I want information for a guided Granada city tour with transfer for {$pax} passengers";
              ?>
              <tr>
                <td class="py-3 px-3"><?= htmlspecialchars($pax) ?> pax</td>
                <td class="py-3 px-3">
    ...
    <div class="mt-10 text-center">
      <a href="https://wa.me/34692926919" target="_blank" rel="noopener"
        ...
        <span class="relative z-10"><?= t('guided.granada_city.cta.info') ?></span>
...
<?= json_encode([
  ...
  '@type'=>'TouristTrip',
  'name'=> t('guided.granada_city.title_short'),
  'description'=> strip_tags(t('guided.granada_city.lead')),
  'provider'=>[
    '@type'=>'TravelAgency',
  ...
  'offers'=>[
    ...
    'url'=>'https://www.transfermarbell.com/servicios/visitas-guiadas/granada-city'
  ],
  'image'=>[
    'https://www.transfermarbell.com/imagenes/excursiones/Alhambra_jardin.jpg',
    'https://www.transfermarbell.com/imagenes/excursiones/Alhambra_torre.jpg',
    'https://www.transfermarbell.com/imagenes/excursiones/Alhambra_barrio_castrense.jpg'
  ]
